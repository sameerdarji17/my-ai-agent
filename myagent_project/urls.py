...
urlpatterns = [
    ...
    path("api/agent/conversations/<uuid:conversation_id>/", agent_views.ConversationDetailView.as_view(), name="conversation-detail"),
    path("api/agent/upload/", agent_views.UploadFileView.as_view(), name="upload-file"),
    path("api/agent/conversations/<uuid:conversation_id>/share/", agent_views.ShareConversationView.as_view(), name="share-conversation"),
